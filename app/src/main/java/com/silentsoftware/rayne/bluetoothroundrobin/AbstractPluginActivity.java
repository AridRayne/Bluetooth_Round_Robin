...
/**
 * Created by Steven on 4/22/2015.
 */
public class AbstractPluginActivity extends Activity {
    /**
    ...
    private void setupTitleApi11() {
        ...
        try {
            ...
            Log.e("BluetoothRoundRobin", "Calling package couldn't be found", e); //$NON-NLS-1$
        }
    ...
    private void setupActionBarApi14() {
        ...
        try {
            ...
            Log.w("BluetoothRoundRobin", "An error occurred loading the host's icon", e); //$NON-NLS-1$
        }
    }
